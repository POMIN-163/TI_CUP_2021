...
public class ti_ndk_stack
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.ndk.stack$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.ndk.stack$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.ndk.stack$$stat$root'];\n");
        sb.append("}\n");
