...
public class ti_ndk_tools_servers
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.ndk.tools.servers$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.ndk.tools.servers$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.ndk.tools.servers$$stat$root'];\n");
        sb.append("}\n");
