...
public class ti_ndk_os
{
    ...
    void $$SINGLETONS()
    {
        ...
        sb.append("}\n");
        sb.append("if ('ti.ndk.os$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.ndk.os$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.ndk.os$$stat$root'];\n");
        sb.append("}\n");
        sb.append("pkg.build.libraries = [\n");
            sb.append("'lib/os.aem4f',\n");
            sb.append("'lib/os_freertos.aem4f',\n");
            sb.append("'lib/os_sem.aem4f',\n");
            sb.append("'lib/os_sem_freertos.aem4f',\n");
            sb.append("'lib/os.am4fg',\n");
            sb.append("'lib/os_freertos.am4fg',\n");
            sb.append("'lib/os_sem.am4fg',\n");
            sb.append("'lib/os_sem_freertos.am4fg',\n");
            sb.append("'lib/os.arm4f',\n");
            sb.append("'lib/os_freertos.arm4f',\n");
            sb.append("'lib/os_sem.arm4f',\n");
            sb.append("'lib/os_sem_freertos.arm4f',\n");
        sb.append("];\n");
        sb.append("pkg.build.libDesc = [\n");
            sb.append("['lib/os.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/os_freertos.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/os_sem.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/os_sem_freertos.aem4f', {target: 'ti.targets.arm.elf.M4F', suffix: 'em4f'}],\n");
            sb.append("['lib/os.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/os_freertos.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/os_sem.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/os_sem_freertos.am4fg', {target: 'gnu.targets.arm.M4F', suffix: 'm4fg'}],\n");
            sb.append("['lib/os.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/os_freertos.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/os_sem.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
            sb.append("['lib/os_sem_freertos.arm4f', {target: 'iar.targets.arm.M4F', suffix: 'rm4f'}],\n");
        sb.append("];\n");
