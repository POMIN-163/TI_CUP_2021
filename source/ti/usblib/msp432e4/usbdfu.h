...
// sending back a tDFUQueryMsp432eProtocol structure indicating that
...
// purpose.
//
// wValue        - 0x23(REQUEST_MSP432E_VALUE)
// wIndex        - Interface number
// wLength       - sizeof(tDFUQueryMsp432eProtocol)
//
//*****************************************************************************
#define USBD_DFU_REQUEST_MSP432E 0x42
#define REQUEST_MSP432E_VALUE    0x23

#define DFU_PROTOCOL_MSP432E_MARKER                                            \
                                0x4C4D
#define DFU_PROTOCOL_MSP432E_VERSION_1                                         \
                                0x0001
...
//*****************************************************************************
//
// The structure sent to the host when a valid USBD_DFU_REQUEST_MSP432E is
...
{
    //
    // The protocol marker(DFU_PROTOCOL_MSP432E_MARKER)
    //
    uint16_t ui16Marker;

    //
    // The protocol version(DFU_PROTOCOL_MSP432E_VERSION_1)
    //
    uint16_t ui16Version;
}
PACKED tDFUQueryMsp432eProtocol;
