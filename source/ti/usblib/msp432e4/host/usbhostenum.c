        ...
        while(1)
        {
            ...
            if(g_sUSBHCD.psUSBINPipes[ui32PipeIdx].iState == ePipeDataReady)
            {
                ...
                if(bUseDMA == false)
                {
                    ...
                    //
                    ui32BytesRead =
                            ui32RemainingBytes > g_sUSBHCD.psDMAInstance->pui32MaxPacketSize[ui32PipeIdx] ? g_sUSBHCD.psDMAInstance->pui32MaxPacketSize[ui32PipeIdx] : ui32RemainingBytes;
                ...
                //
                if(ui32BytesRead < g_sUSBHCD.psDMAInstance->pui32MaxPacketSize[ui32PipeIdx])
                {
                    //
                ...
                else
                {
                    ...
                    // buffer.
                    //
                    pui8Data += g_sUSBHCD.psDMAInstance->pui32MaxPacketSize[ui32PipeIdx];
                }
                break;
            }
...
USBHCDPipeFree(uint32_t ui32Pipe)
{
    ...
    else if(ui32Pipe & EP_PIPE_TYPE_IN)
    {
        ...
        // Free up the FIFO memory used by this endpoint.
        //
        if(g_sUSBHCD.psUSBINPipes[ui32Index].ui8FIFOSize)
        {
            FIFOFree(&g_sUSBHCD.psUSBINPipes[ui32Index]);
        }
...
USBHCDGetConfigDescriptor(uint32_t ui32Index, tUSBHostDevice *psDevice)
{
	...
	sConfigDescriptor.wTotalLength = 0;
