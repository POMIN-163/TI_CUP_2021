...
public class ti_utils_runtime
{
    ...
    void $$OBJECTS()
    {
        pkgP = (Proto.Obj)om.bind("ti.utils.runtime.Package", new Proto.Obj());
        pkgV = (Value.Obj)om.bind("ti.utils.runtime", new Value.Obj("ti.utils.runtime", pkgP));
    }

    void $$SINGLETONS()
    {
        pkgP.init("ti.utils.runtime.Package", (Proto.Obj)om.findStrict("xdc.IPackage.Module", "ti.utils.runtime"));
        pkgP.bind("$capsule", $$UNDEF);
        pkgV.init2(pkgP, "ti.utils.runtime", Value.DEFAULT, false);
        pkgV.bind("$name", "ti.utils.runtime");
        pkgV.bind("$category", "Package");
        pkgV.bind("$$qn", "ti.utils.runtime.");
        ...
        sb.append("var pkg = xdc.om['ti.utils.runtime'];\n");
        sb.append("if (pkg.$vers.length >= 3) {\n");
            sb.append("pkg.$vers.push(Packages.xdc.services.global.Vers.getDate(xdc.csd() + '/..'));\n");
        sb.append("}\n");
        sb.append("if ('ti.utils.runtime$$stat$base' in xdc.om) {\n");
            sb.append("pkg.packageBase = xdc.om['ti.utils.runtime$$stat$base'];\n");
            sb.append("pkg.packageRepository = xdc.om['ti.utils.runtime$$stat$root'];\n");
        sb.append("}\n");
    ...
    void $$INITIALIZATION()
    {
        ...
        ((Value.Arr)om.findStrict("$packages", "ti.utils.runtime")).add(pkgV);
    }
